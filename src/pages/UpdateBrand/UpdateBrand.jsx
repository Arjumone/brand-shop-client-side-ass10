...
const UpdateBrand = () => {
    ...
    const {image,name,brandName,typeOfProduct,price,shortDescription,rating} =brand;
    ...
    const handleUpdateProducts = e =>{
      ...
      const updateProducts = {image,name,brandName,typeOfProduct,price,shortDescription,rating}
